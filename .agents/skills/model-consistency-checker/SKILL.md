    ---
    name: "model-consistency-checker"
    pack: "uml-analysis-modelling-pack"
    purpose: "Check consistency across use cases, class models, sequence diagrams, activity diagrams, state models, and deployment assumptions."
    ...
    handoffs: ["requirements pack later", "verification pack later", "architecture pack later"]
    ---
    # model-consistency-checker

    ## Purpose
    Check consistency across use cases, class models, sequence diagrams, activity diagrams, state models, and deployment assumptions.
    ...
    ## Handoff targets
    - requirements pack later
- verification pack later
