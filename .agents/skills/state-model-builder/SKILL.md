    ---
    name: "state-model-builder"
    pack: "uml-analysis-modelling-pack"
    purpose: "Model the lifecycle of a key entity or subsystem through states, transitions, events, and guards."
    ...
    handoffs: ["activity-diagram-builder", "model-consistency-checker", "scenario-to-uml-transformer"]
    ---
    # state-model-builder

    ## Purpose
    Model the lifecycle of a key entity or subsystem through states, transitions, events, and guards.
