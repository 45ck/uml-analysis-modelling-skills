    ---
    name: "use-case-description-writer"
    pack: "uml-analysis-modelling-pack"
    purpose: "Write structured use-case descriptions with trigger, preconditions, main success scenario, alternate flows, exception flows, and postconditions."
    ...
    handoffs: ["activity-diagram-builder", "sequence-diagram-builder", "model-consistency-checker"]
    ---
    # use-case-description-writer

    ## Purpose
    Write structured use-case descriptions with trigger, preconditions, main success scenario, alternate flows, exception flows, and postconditions.
