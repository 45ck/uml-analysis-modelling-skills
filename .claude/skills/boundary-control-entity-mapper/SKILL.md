    ---
    name: "boundary-control-entity-mapper"
    pack: "uml-analysis-modelling-pack"
    purpose: "Separate interface-facing, coordination, and domain responsibilities using boundary, control, and entity thinking."
    ...
    handoffs: ["design-class-modeler", "sequence-diagram-builder", "model-consistency-checker"]
    ---
    # boundary-control-entity-mapper

    ## Purpose
    Separate interface-facing, coordination, and domain responsibilities using boundary, control, and entity thinking.
