    ---
    name: "scenario-to-uml-transformer"
    pack: "uml-analysis-modelling-pack"
    purpose: "Take a scenario or narrative and propose the most useful UML views to represent it, with a starter structure for each."
    ...
    handoffs: ["use-case-modeler", "activity-diagram-builder", "sequence-diagram-builder"]
    ---
    # scenario-to-uml-transformer

    ## Purpose
    Take a scenario or narrative and propose the most useful UML views to represent it, with a starter structure for each.
