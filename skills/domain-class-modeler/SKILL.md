    ---
    name: "domain-class-modeler"
    pack: "uml-analysis-modelling-pack"
    purpose: "Build a domain class model from narrative requirements by identifying entities, attributes, associations, and multiplicities without prematurely adding implementation detail."
    ...
    handoffs: ["multiplicity-checker", "domain-vs-design-model-differentiator", "model-consistency-checker"]
    ---
    # domain-class-modeler

    ## Purpose
    Build a domain class model from narrative requirements by identifying entities, attributes, associations, and multiplicities without prematurely adding implementation detail.
