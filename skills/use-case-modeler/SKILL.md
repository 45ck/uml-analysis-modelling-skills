    ...
    purpose: "Identify actors, system boundaries, major goals, and use cases from a brief, then organize them into a coherent use-case model."
    ...
    handoffs: ["use-case-description-writer", "activity-diagram-builder", "scenario-to-uml-transformer"]
    ---
    # use-case-modeler

    ## Purpose
    Identify actors, system boundaries, major goals, and use cases from a brief, then organize them into a coherent use-case model.
