    ---
    name: "design-class-modeler"
    pack: "uml-analysis-modelling-pack"
    purpose: "Turn analyzed requirements or domain concepts into a design-level class model with responsibilities, operations, visibility, and collaboration boundaries."
    ...
    handoffs: ["boundary-control-entity-mapper", "inheritance-abstraction-reviewer", "model-consistency-checker"]
    ---
    # design-class-modeler

    ## Purpose
    Turn analyzed requirements or domain concepts into a design-level class model with responsibilities, operations, visibility, and collaboration boundaries.
