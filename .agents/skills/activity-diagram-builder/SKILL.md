    ...
    purpose: "Translate workflows and use-case flows into activity diagrams that make control flow, branching, concurrency, and handoffs explicit."
    ...
    handoffs: ["scenario-to-uml-transformer", "model-consistency-checker", "state-model-builder"]
    ---
    # activity-diagram-builder

    ## Purpose
    Translate workflows and use-case flows into activity diagrams that make control flow, branching, concurrency, and handoffs explicit.
