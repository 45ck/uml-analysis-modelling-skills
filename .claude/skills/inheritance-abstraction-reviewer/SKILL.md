    ---
    name: "inheritance-abstraction-reviewer"
    pack: "uml-analysis-modelling-pack"
    purpose: "Evaluate whether inheritance, interfaces, or composition better represent shared behavior and abstraction in the model."
    ...
    handoffs: ["design-class-modeler", "domain-vs-design-model-differentiator", "model-consistency-checker"]
    ---
    # inheritance-abstraction-reviewer

    ## Purpose
    Evaluate whether inheritance, interfaces, or composition better represent shared behavior and abstraction in the model.
